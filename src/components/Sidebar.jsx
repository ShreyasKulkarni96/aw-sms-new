                    ...
                    <nav>
                        <ul>
                            ...
                            {(decodedToken.role === "ADMIN" || decodedToken.role === "SUPER_ADMIN" || decodedToken.role === "STAFF") && <Link to='/academicyear-management'>
                                <li className='list'>
                                    <div className="list-items">
                                        ...
                                        <span className='list-name ml-4'>AY Management</span>
                                    </div>
                                </li>
                            </Link>}
                            ...
                            <Link to="/reset-password">
                                <li className='list'>
                                    <div className="list-items">
                                        <LockResetIcon className='icons' style={{ fontSize: '26px' }} />
                                        <span className='list-name ml-4'>Reset Password</span>
                                    </div>
                                </li>
                            </Link>

                            {/* --------------------------LOGOUT---------------------*/}
                            <Link Link to="/" onClick={handleLogout}>
                                <li className='list'>
                                    <div className="list-items">
