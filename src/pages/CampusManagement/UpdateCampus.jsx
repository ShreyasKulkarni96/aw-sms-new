...
const UpdateCampus = () => {
    ...
    const updateCampus = async campusDetails => {
        try {
            ...
            const { data } = await APIService.patch(`${CAMPUS_API}/${params.campusId}`, campusDetails);
                    ...
                    <main className='main'>
                        <div className='main-grid'>
                            <div className='page-content'>
                                ...
                                {/* -------------------------------------ADD SPACES-------------------------------------- */}
                                <TableComponent columns={columns} data={updateSpacesWithSerialNo} tableName="Add Spaces" isButton={true} height="540px" onClick={onAction} />
                            </div>
                        </div>
                    </main>
                </div>
