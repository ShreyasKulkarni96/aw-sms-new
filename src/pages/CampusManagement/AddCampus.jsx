...
const AddCampus = () => {
    ...
    const [formData, setFormData] = useState(campusDetails);

    const { facilityName, contactPerson, facilityAddress, contactPersonEmail, contactPersonPhone, city, state } = formData;
    ...
    const onMutate = (e) => {
        ...
        if (id.toLowerCase().includes('space')) {
            if (id === 'spaceCapacity') {
                setSpaceData(prevState => ({ ...prevState, [id]: +value }));
            } else {
                setSpaceData(prevState => ({ ...prevState, [id]: value }));
            }
        } else {
    ...
    const addNewCampus = async () => {
        try {
            ...
            const { data } = await APIService.post(CAMPUS_API, payload);
                            ...
                            <div className='page-content'>
                                ...
                                <div className='top-card'>
                                    ...
                                    <div className='card-content mt-3'>
                                        ...
                                        <div className="w-full">
                                            <div className="mr-4">
                                                <label className="form-input" htmlFor="state">
                                                    Select State
                                                </label>
                                                <select id="state" className='form-select' onChange={onMutate} value={state}>
                                ...
                                {/* -------------------------------------ADD SPACES-------------------------------------- */}
                                <TableComponent columns={columns} data={spaces} tableName="Add Spaces" isButton={true} height="540px" onClick={onAction} />
                            </div>
                        </div>
                    </main>
                </div>
                                ...
                                <div className='card-content mt-2'>
                                    <div className="w-full">
                                        <label className="form-input" id="typeOfSpace">
                                            Select Type of Spaces<sup className="important">*</sup>
                                        </label>
