...
const AddFaculty = () => {
    ...
    const onSubmit = async () => {
        ...
        const accountNumberFormat = /^[0-9]{9,18}$/;
                        ...
                        <div className='main-grid'>
                            <div className='page-content'>
                                ...
                                <div className='top-card h-[800px] relative'>
                                    ...
                                    {/* ----------------------ATTENDANCE DETAILS------------------ */}
                                    <div>
                                        <div onClick={() => handleSectionToggle('attendance')} className={openSection === 'attendance' ? "accordion-card-open mt-4" : "accordion-card-close mt-4"}>
                                            <div className='accordion-details'>
                                                <span className="accordion-title">Attendance Details</span>
                                                {openSection === 'attendance' ? <KeyboardArrowUpRoundedIcon style={{ fontSize: '30px' }} /> : <KeyboardArrowDownRoundedIcon style={{ fontSize: '30px' }} />}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {/* ----------------------ATTENDANCE DETAILS------------------ */}
                                    <div>
                                        <div onClick={() => handleSectionToggle('course')} className={openSection === 'course' ? "accordion-card-open mt-4" : "accordion-card-close mt-4"}>
                                            <div className='accordion-details'>
                                                <span className="accordion-title">Assigned Course</span>
                                                {openSection === 'course' ? <KeyboardArrowUpRoundedIcon style={{ fontSize: '30px' }} /> : <KeyboardArrowDownRoundedIcon style={{ fontSize: '30px' }} />}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {/* ----------------------ATTENDANCE DETAILS------------------ */}
                                    <div>
                                        <div onClick={() => handleSectionToggle('ratings')} className={openSection === 'ratings' ? "accordion-card-open mt-4" : "accordion-card-close mt-4"}>
                                            <div className='accordion-details'>
                                                <span className="accordion-title">Student Ratings</span>
                                                {openSection === 'ratings' ? <KeyboardArrowUpRoundedIcon style={{ fontSize: '30px' }} /> : <KeyboardArrowDownRoundedIcon style={{ fontSize: '30px' }} />}
                                            </div>
                                        </div>
                                    </div>
